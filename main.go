...
// // // STK PUSH REQUEST
// // // ======================
// // func SendSTKPush(phone string, amount int, userName, item string) (*STKPushResponse, error) {
...
// // 	transactionDesc := fmt.Sprintf("%s paying for %s", userName, item)
// // 	if len(transactionDesc) > 50 {
// // 		transactionDesc = transactionDesc[:50] // truncate if too long
// // 	}
...
// // 		CallBackURL:       "https://example.com/fakecallback", // Sandbox ignores
...
// // // ======================
// // func main() {
// // 	phone := "254798062459"        // Sandbox test number
// // 	amount := 1                    // Amount
// // 	userName := "Alice"            // Example user name
// // 	item := "Premium Bot Subscription" // Example item

// // 	fmt.Println("Sending STK Push...")
// // 	resp, err := SendSTKPush(phone, amount, userName, item)
// // 	if err != nil {
...
// // 				fmt.Println("Transaction result received!")
// // 				break
// // 			}
// // 		}
// // 	}
...
// 	ShortCode       = "174379"
// 	PassKey         = "bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919"
// 	AccountRef      = "AlgoCdk"          // <- changed here
// 	TransactionDesc = "Daraja Go SDK STK Push"
// 	SandboxBaseURL  = "https://sandbox.safaricom.co.ke"
// )
...
// // Payment struct to handle purchase or subscription
// type Payment struct {
// 	Type       string // "purchase" or "subscription"
// 	Item       string
// 	Amount     int
// 	Frequency  string // e.g., "week", "month" for subscriptions
// 	BuyerName  string
// 	BuyerPhone string
// }
